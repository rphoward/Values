(def-ref business-model
  ...
  (stage-view "Front stage: channels, relationships, revenue. Back stage: activities, resources, partners, costs.")
  (bm-seven-questions osterwalder_7_bm_questions)
  (compare-prompts "Contrast transactional product model vs recurring service/outcome model (MedTech spectrum, Hilti product-to-service shift) as text prompts only — no book figure reproduction")
  ...
  (atom
    ...
    (kb bm-question recurring_revenues earning_versus_spending)
  ...
  (atom
    ...
    (kb bm-question game_changing_cost_structure others_do_the_work)
  ...
  (atom
    ...
    (kb bm-question switching_costs protection_from_competition)
