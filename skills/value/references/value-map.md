(def-ref value-map
  ...
  (product-categories value_map_categories.products_and_services)
  (fit-rules value_map_categories.fit_check_rules)
  (ad-lib-formula "Our [Products/Services] help(s) [Customer Segment] who want to [Customer Jobs] by [Pain Relievers] and [Gain Creators] (unlike [Competing Value Proposition]).")
  ...
  (atom
    ...
    (kb product-categories value_map_categories.products_and_services)
  ...
  (atom
    ...
    (kb fit-checkmark-matrix "Mark matched items [✓] -> profile claim; mark unmatched [X] as orphan candidates per fit-rules.orphan_features")
